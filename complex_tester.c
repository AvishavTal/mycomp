...
void print_com_test(){
    ...
    complex pos_img;
    complex neg_img;
    complex only_img_pos;
    real= init_comp(1, 0);
    only_img= init_comp(0, -1);
    only_img_pos= init_comp(0,2);
...
void sub_com_tester(){
    ...
    complex1= init_comp(1,1);
    complex2= init_comp(1,1);
    result= sub_comp(complex1,complex2);
    printf("0=\t");
    print_comp(result);

    complex1= init_comp(4,5);
    complex2= init_comp(2,1);
    result= sub_comp(complex1,complex2);
    printf("2+4i=\t");
    print_comp(result);

    complex1= init_comp(4,5);
    complex2= init_comp(5,6);
    result= sub_comp(complex1,complex2);
    printf("-1-i=\t");
    print_comp(result);
